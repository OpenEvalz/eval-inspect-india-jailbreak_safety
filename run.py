#!/usr/bin/env python3
"""Run ONE problem of inspect-india-jailbreak_safety through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/jailbreak_safety"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one inspect-india-jailbreak_safety problem via TrustedRouter")
