# eval-inspect-india-jailbreak_safety
...
Evaluates LLM robustness to jailbreak attempts within the Indian context, part of the Inspect
India Evals suite for assessing model performance in the Indian context.

## At a glance

| | |
|---|---|
| Upstream | [`register/inspect-india-jailbreak_safety`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/register/inspect-india-jailbreak_safety) |
| Group | — |
| Total samples | 0 |
...
```bash
inspect eval inspect_evals/jailbreak_safety \
  --sample-id "<sample-id>" \
